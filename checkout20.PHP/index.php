...
if (isset($_POST['submit'])) {
 ...
 //$ten= $_POST["txt_test"];
	...
	$url= $nl->buildCheckoutUrlExpand($return_url, $receiver, $transaction_info, $order_code, $price*1000, $currency, $quantity, $tax, $discount , $fee_cal,    $fee_shipping, $order_description,  $affiliate_code);
...
function check(){
		var price = document.Test.txt_gia.value*1000;
...
<table>
    ...
    -->
	<tr><th><strong>Số điện thoại:</strong></th><td><input class="nganluong"  type="text" name="txt_phone" size="28" placeholder="Số điện thoại" value="<?php echo $_GET['so_dien_thoai'] ?>"/></td></tr>
	<tr><th><strong>Số tiền thanh toán:</strong></th><td><input class="nganluong" name="txt_gia" type="text" size="28" placeholder="Số tiền thanh toán" value="<?php echo $_GET['tong'] ?>"/></td></tr>	
