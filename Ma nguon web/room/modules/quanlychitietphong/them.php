<form action="modules/quanlychitietphong/xuly.php" method="post" enctype="multipart/form-data" style="position:relative">
<table width="400px" border="1" style="font-size:16px">
  <tr>
    <td colspan="2" style="background-color:#f2f2f2"><div align="center"><em>Thêm chi tiết phòng</em></div></td>
  </tr>
  <tr>
    <td width="150px">Số phòng</td>
    <td><input type="text" name="so_phong" readonly value="<?php echo $_GET['id'] ?>" required></td>
  </tr>
  <tr>
    <td width="150px">Tháng</td>
    <td><input type="number" name="thang" min="1" max="12" required></td>
  </tr>
  <tr>
    <td width="150px">Tên người thuê</td>
    <td><input type="text" name="ten_nguoi_thue"></td>
  </tr>
  <tr>
